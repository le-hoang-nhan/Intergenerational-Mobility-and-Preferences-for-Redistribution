...
cd "$path"
cd logs
log using "logfig7_test_political", text replace
...
tabstat d*left, s(mean) save
tabstatmat A
mat2txt, matrix(A) saving(Table_for_Left) replace ///* first to store it in txt
title("Table : statistics of the difference between male and female in Left-wing")


tabstat t*left, s(mean) save
tabstatmat B
mat2txt, matrix(B) saving(Table_for_Left) append ///
title("Table : statistics of significant p-value to Left-wing")



dataout using Table_for_Left.txt, excel replace  //change it to excel table




tabstat d*right, s(mean) save
tabstatmat A
mat2txt, matrix(A) saving(Table_for_Right) replace ///
title("Table : statistics of the difference between male and female in Right-wing")


tabstat t*right, s(mean) save
tabstatmat B
mat2txt, matrix(B) saving(Table_for_Right) append ///
title("Table : statistics of significant p-value to Right-wing")



dataout using Table_for_Right.txt, excel replace
