...
cd "$path"
cd logs
log using "logtab6_male", text replace
...
* Table start
file open holder using tab6_treatment_effects_male.tex, write replace text
...
appendfile temp_reduced_header_panelA.tex tab6_treatment_effects_male.tex
appendfile temp_reduced_PanelA.tex tab6_treatment_effects_male.tex
appendfile temp_reduced_header_panelB.tex tab6_treatment_effects_male.tex
appendfile temp_reduced_PanelB.tex tab6_treatment_effects_male.tex
appendfile temp_IV_header_panelC.tex tab6_treatment_effects_male.tex
appendfile temp_IV_PanelC.tex tab6_treatment_effects_male.tex
appendfile temp_IV_header_panelD.tex tab6_treatment_effects_male.tex
appendfile temp_IV_PanelD.tex tab6_treatment_effects_male.tex
appendfile temp_end.tex tab6_treatment_effects_male.tex	
