...
cd "$path"
cd logs
log using "logtab3_female", text replace
...
* Tables start
file open holder using tab3_correlations_mobility_policy_first_part_female.tex, write replace text
...
file close holder
file open holder using tab3_correlations_mobility_policy_second_part_female.tex, write replace text
file write holder "\begin{center}\begin{tabular}{lccccccccc} " _n
file write holder "&   & & Support & & Unequal Opp. & &  &  & \\" _n
file write holder "& Budget & Support & Equality & Government & Very Serious & Budget & Tax Rate & Tax Rate & Govt. \\" _n
file write holder "& Opp. & Estate Tax & Opp. Policies & Interv. & Problem & Safety Net & Top 1 & Bottom 50 & Tools \\" _n
...
appendfile temp_q1_header.tex tab3_correlations_mobility_policy_first_part_female.tex
appendfile temp_all_Q1_PanelA.tex tab3_correlations_mobility_policy_first_part_female.tex
appendfile temp_all_Q5_PanelA.tex tab3_correlations_mobility_policy_first_part_female.tex
appendfile temp_q1_header_leftright.tex tab3_correlations_mobility_policy_first_part_female.tex
appendfile temp_all_Q1_PanelB.tex tab3_correlations_mobility_policy_first_part_female.tex
appendfile temp_q5_header_leftright.tex tab3_correlations_mobility_policy_first_part_female.tex
appendfile temp_all_Q5_PanelB.tex tab3_correlations_mobility_policy_first_part_female.tex
appendfile temp_end.tex tab3_correlations_mobility_policy_first_part_female.tex
...
appendfile temp_q1_effort_header.tex tab3_correlations_mobility_policy_second_part_female.tex
appendfile temp_all_Q1_effort_PanelC.tex tab3_correlations_mobility_policy_second_part_female.tex
appendfile temp_all_Q5_effort_PanelC.tex tab3_correlations_mobility_policy_second_part_female.tex
appendfile temp_q1_effort_header_leftright.tex tab3_correlations_mobility_policy_second_part_female.tex
appendfile temp_all_Q1_effort_PanelD.tex tab3_correlations_mobility_policy_second_part_female.tex
appendfile temp_q5_effort_header_leftright.tex tab3_correlations_mobility_policy_second_part_female.tex
appendfile temp_all_Q5_effort_PanelD.tex tab3_correlations_mobility_policy_second_part_female.tex
appendfile temp_effort_end.tex tab3_correlations_mobility_policy_second_part_female.tex
